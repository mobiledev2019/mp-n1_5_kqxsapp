...
public class LiveTFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view =  inflater.inflate(R.layout.fragment_live_t, container, false);
...
//        stringList.add("525134");
        ResultRepository.getInstance().getResult("2019-04-02", 1L, new OnResponseListener<ResultB>() {
            ...
            public void onSuccess(ResultB data) {
                ...
                rcvKQ = view.findViewById(R.id.rcv_kq_gl);
